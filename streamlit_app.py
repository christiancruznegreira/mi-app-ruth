...
st.markdown("""
    ...
    /* FLECHA DE RESCATE (PESTAÑA ROJA FIJA) */
    ...
    [data-testid="stSidebar"] {
        background-color: rgba(15, 18, 22, 0.7) !important;
    ...
    /* TÍTULO NEÓN RESPONSIVO */
    @keyframes flicker {
        0%, 18%, 22%, 25%, 53%, 57%, 100% { text-shadow: 0 0 4px #f00, 0 0 11px #f00, 0 0 40px #f00; color: #ff4b4b; }
        20%, 24%, 55% { text-shadow: none; color: #330000; }
    }
    .ruth-header { text-align: center; color: #ff4b4b; font-size: 3rem; animation: flicker 3s infinite alternate; font-weight: 100; letter-spacing: 0.5rem; margin-top: 1rem; }
    .ruth-subtitle { text-align: center; color: #666; font-size: 0.6rem; letter-spacing: 0.2rem; margin-top: -5px; margin-bottom: 2rem; font-weight: bold;}

    /* BOTONES GHOST (OPTIMIZADOS PARA MÓVIL) */
    .stButton>button { 
        border: none !important; background-color: transparent !important; color: #888 !important; 
        width: 100% !important; text-transform: uppercase; font-size: 0.45rem !important; 
        letter-spacing: 0.05rem !important; transition: 0.3s;
    }
    .stButton>button:hover { color: #ff4b4b !important; text-shadow: 0 0 8px #f00; }
    ...
    div[data-testid="stTextInput"] input { 
        ...
        color: white !important; border-radius: 10px !important; text-align: center;
    }
